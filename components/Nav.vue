<template>
  <nav class="flex items-center justify-between flex-wrap bg-primary p-6 shadow-md">
    ...
    <div class="block lg:hidden">
      <button class="flex items-center px-3 py-2 border rounded text-white border-primary-light hover:text-primary-lightest hover:border-white">
        <svg
    ...
    <div class="w-full block flex-grow lg:flex lg:flex-no-grow lg:items-center lg:w-auto">
      <div class="text-sm lg:flex-grow">
        <nuxt-link
          to="/"
          class="block mt-4 lg:inline-block lg:mt-0 text-primary-lighter hover:text-primary-lightest mr-4 no-underline">
          Home
        </nuxt-link>
        <nuxt-link
          to="elements"
