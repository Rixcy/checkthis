  ...
  <span>
    ...
    <div class="flex items-stretch flex-wrap">
      ...
      <section class="sm:w-full md:w-1/3 mr-6 mb-6 rounded-lg overflow-hidden shadow bg-gradient-light-blue p-6">
        ...
        <a
          href="https://github.com/Jeroen-G/Crosswind"
          target="_blank"
          class="no-underline text-sm float-right font-semibold text-white rounded-full bg-blue-dark p-2">Go to GitHub &rarr; </a>
      </section>
    </div>
  </span>
</template>
